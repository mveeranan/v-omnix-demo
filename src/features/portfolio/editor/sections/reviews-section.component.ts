...
import { Hash, MessageSquare, Plus, Trash2, UserRound } from 'lucide-angular';
    ...
    >
      ...
      <div view class="admin-detail-view admin-detail-view--rich">
        ...
        <app-admin-detail-card [full]="true">
          ...
          <app-admin-detail-item [icon]="totalIcon" label="Total reviews" [value]="draft()?.reviews?.length ?? 0" />
